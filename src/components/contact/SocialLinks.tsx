...
const SocialLinks = () => {
  return (
    <div className="flex items-center justify-around">
      ...
      >
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 12.713l-11.999-7.713v13.999c0 .552.448 1 1 1h20c.552 0 1-.448 1-1v-13.999l-11.999 7.713zm11.999-9.713h-23.999c-.552 0-1 .448-1 1v.217l12 7.739 12-7.739v-.217c0-.552-.448-1-1-1z" />
        </svg>
      </a>
    </div>
  );
