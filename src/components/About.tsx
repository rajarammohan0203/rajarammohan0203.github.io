...
const About = () => {
  ...
  <section id="about" className="py-20 md:py-28 relative">
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Responsive two-column layout: About on left, 3 cards in column on right */}
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-10 items-stretch">
          {/* Left: About/Terminal */}
          <div className="flex-1 min-w-0 flex flex-col justify-stretch min-h-[550px]">
            <div className="glass-card rounded-2xl p-4 sm:p-6 lg:p-8 flex flex-col h-full min-h-[500px]">
              {showTerminal ? (
